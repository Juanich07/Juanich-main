...
<html lang="en">
    ...
    <body>
        <?php 
            ...
            $query = "SELECT * FROM transactions ORDER BY name LIMIT ".$page_first_result.','.$result_per_page;
                                ...
                                <div class="col-md-12">
                                    <div class="card strpied-tabled-with-hover">
                                        <div class="card-header ">
                                            ...
                                            <p class="card-category">Here is the lists of transaction</p>
                                        </div>
                                            ...
                                            <table class="table table-hover table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $transactions['employee_id']; ?></td>
                                                        <td><?php echo $transactions['office_id']; ?></td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex justify-content-end">
                                                                <a href="office-edit.php?id=<?php echo $transactions['id']; ?>">
                                                                    <button class="btn btn-warning btn-fill mx-1">Edit</button>
                                                                </a>
                                                                <a href="javascript:void(0);" onclick="confirmDelete(<?php echo $transactions['id']; ?>)">
